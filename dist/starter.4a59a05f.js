...
var _regeneratorRuntime = require("regenerator-runtime"); //pollyfilling asynca/await
// if (module.hot) {
//   module.hot.accept();
// }
...
const controlRecipes = async function() {
    try {
        ...
        await _modelJs.loadRecipe(id, (0, _configJs.key));
        const recipe = _modelJs.state.recipe;
        //3 -> rendering the recipe
        (0, _recipeViewJsDefault.default).render(recipe);
    } catch (error) {
        console.log(error);
        (0, _recipeViewJsDefault.default).renderError(`${error} \u{1F4A5} \u{1F4A5}`);
    }
};
const controlSearchResults = async function() {
    try {
        ...
        if (!query) return;
        await _modelJs.loadSearchResults(query, (0, _configJs.key));
...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerEvent(controlRecipes);
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./view/recipeView.js":"7jYBF","./config.js":"2hPh4","./view/searchView.js":"joADT","./view/resultsView.js":"lVmou","./view/paginationView.js":"f2E9A","./view/bookmarksView.js":"4Gex6","./view/addRecipeView.js":"brqkw","regenerator-runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id, key) {
    try {
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}${id}?key=${key}sdsd`);
...
const loadSearchResults = async function(query, key) {
    try {
        state.search.query = query;
        const data = await (0, _helpersJs.AJAX)(`${(0, _configJs.API_URL)}?search=${query}&key=${key}`);
...
const uploadRecipe = async function(newRecipeData) {
    try {
        ...
        const ingredients = Object.entries(newRecipeData).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ingredient)=>{
            ...
            if (ingredientArr.length !== 3) throw new Error('Wrong ingredient format!! Please use the right format!!');
...
const key = '6a06284b-d02b-4b06-894c-333a270e5594';
const TIMEOUT_SEC = 30; // Reduzido para teste
...
},{"./config.js":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7jYBF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = 'Sorry! We could not find your recipe';
    _message = '';
    _generateMarkup() {
        return `
    ...
    addHandlerEvent(handler) {
        //modern way of an EventListener
        [
            'hashchange',
            'load'
...
},{"./View.js":"9UDjB","url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9UDjB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    ...
    render(data, render = true) {
        ...
        if (Array.isArray(data.results) && data.results.length > 0) {
            ...
            if (isKeyLimePie === 'Key lime pie' && isSingleRecipe === 1) return this.renderError();
        }
        this._data = data;
...
},{"./View.js":"9UDjB","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lVmou":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./View.js":"9UDjB","./previewView.js":"lWbv4","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"lWbv4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class paginationView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = 'Sorry! We could not find your recipe! Try a valid query';
    _message = '';
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = 'Sorry! We could not find your bookmark! Find a recipe and bookmark it :)';
    _message = '';
...
},{"./previewView.js":"lWbv4","./View.js":"9UDjB","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"brqkw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _message = 'Recipe was succesfully uploaded to our database :)';
...
},{"./View.js":"9UDjB","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")
